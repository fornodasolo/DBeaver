...
update  guacamole_user_attribute set attribute_value='totpdisabled' dove user_id='24' and attribute_name='guac-totp-key-secret';

-- UPDATE guacamole_user_attribute SET attribute_value='totpdisabled' WHERE attribute_name = 'guac-totp-key-secret' and user_id = '?';
...
WHERE guacamole_entity.name = 'vida_db1';
